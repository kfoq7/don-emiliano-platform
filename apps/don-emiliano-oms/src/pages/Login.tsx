      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8 animate-fade-in-up">
        ...
        <form onSubmit={login} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full bg-primary hover:bg-action-hover text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg active:scale-[0.98] ${
